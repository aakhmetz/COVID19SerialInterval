...
<p align="center">
  <img src="figures/A-model_selection.png" height="220" title="Model selection (certain pairs)">
</p>
...
<p align="center">
  <img src="figures/B-model_selection.png" height="220" title="Model selection (certain pairs)">
</p>
...
**4. (complimentary)** Initial analysis of six pairs from [[Li et al 2020 NEJM](https://www.nejm.org/doi/full/10.1056/NEJMoa2001316)]. We have also added our very initial analysis of six pairs from Li et al 2020 NEJM paper. Differently from the authors who implemented informative priors on the parameters as it was from SARS-CoV-1, we used weekly informative (standard) priors.
...
<p align="center">
  <img src="figures/D-model_selection.png" height="220" title="Model selection (certain pairs)">
</p>
